...
const pageDefaults = {
    ...
    classrooms: {
        ...
        contentSecondary: `
            ...
            <h3>
                <strong>
                    Optional 4-year-old Preschool Program
                </strong>
            </h3>
            <p>
                ...
                <li>
                    ...
                    to comprehend the physical and natural world through observation, description, prediction, and data gathering
                </li>
                <li>
                    <strong>
                        Logic and Reasoning:
                    </strong>
                    Practicing sequencing, problem-solving, and critical thinking.
                </li>
                </ul>
            </p>
        `,
    ...
    steam: {
        ...
        contentSecondary: `
            ...
            <p>
                <img src="${django.staticUrl + 'img/steam_art.png'}" />
            </p>
        `,
    },
    preschool: {
        ...
        content: `
            <p>
                ...
                <br>
                <strong>
                    Interscope curriculum
                </strong>
                offers additional resources designed to support daily learning. Includes
                ...
                to comprehend the physical and natural world through observation, description, prediction,
                and data gathering.
                <br>
                <br>
                <strong>
                ...
                Learning about numbers, patterns, sorting, and ordering; learning to utilize numbers to add,
    ...
    school_age: {
        ...
        <p>
            <strong>
                If there is a bus cancellation, we are unable to bus your child to school.
            </strong>
        </p>
        `,
        contentSecondary: `
        ...
        <p>
            <strong>
                The Village Childcare Center follows KPS school schedule.
            </strong>
        </p>
        `,
    },
